...
const TEST_CALLS = {
  plumbing_emergency: {
    ...
    Transcript:
      'Hi, I need emergency plumbing help. My basement is flooding from a burst pipe at 123 Main Street. Can you come out today around 2 PM? My name is John Smith, my phone number is 555-123-4567.',
  ...
  real_estate_showing: {
    ...
    Transcript:
      "Hello, I'd like to schedule a showing for the property at 456 Oak Avenue. I'm available this Saturday morning around 10 AM. My name is Sarah Johnson, you can reach me at 555-987-6543.",
