...
function StatusDropdown({
  ...
  return (
    <div ref={dropdownRef} className="relative">
      ...
      >
        <div
          className={`w-2 h-2 rounded-full ${statusToken.dot} animate-pulse`}
        />
          ...
          <div className="p-1">
            {statusOptions.map((option) => {
              ...
              return (
                ...
                >
                  <div
                    className={`w-2 h-2 rounded-full ${optionToken.dot} ${isSelected ? 'animate-pulse' : ''}`}
                  />
...
export default function EventsList({
  ...
  const isAllCurrentPageSelected =
    currentEvents.every((event) => selectedEventIds.includes(event.id)) &&
  ...
  const EmptyState = () => (
    <div className="text-center py-16 px-6 animate-in fade-in duration-500">
      ...
      <p className="text-muted-foreground max-w-md mx-auto">
        Events extracted from your calls will appear here. Make your first call
        to get started.
      </p>
    </div>
  );
        ...
        <div className="overflow-x-auto">
          <table className="w-full">
            <thead className="bg-muted/30 border-b border-border">
              <tr>
                <th className="text-left p-6 font-semibold text-sm text-foreground tracking-wide">
                  Event
                </th>
                <th className="text-left p-6 font-semibold text-sm text-foreground tracking-wide">
                  Customer
                ...
                <th className="text-right p-6 font-semibold text-sm text-foreground tracking-wide">
                  Actions
                </th>
              </tr>
            </thead>
                    ...
                    >
                      ...
                      <td className="p-6">
                        <StatusDropdown
                          ...
                          onStatusChange={(status) =>
                            handleStatusUpdate(event.id, status)
                          }
                      ...
                      <td className="p-6">
                        <div className="flex items-center justify-end gap-2">
                          ...
                          <button
                            onClick={() =>
                              handleAction('view-call', event.id, event.call_id)
                            }
        ...
        >
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="text-sm text-muted-foreground font-medium">
              ...
              to{' '}
              <span className="font-semibold text-foreground">
                {Math.min(endIndex, events.length)}
              </span>{' '}
              of{' '}
              <span className="font-semibold text-foreground">
                {events.length}
