...
const statusOptions = [
  { value: 'pending', label: 'Pending', color: 'text-amber-600 bg-amber-50 border-amber-200', icon: '⏳' },
  { value: 'confirmed', label: 'Confirmed', color: 'text-blue-600 bg-blue-50 border-blue-200', icon: '✅' },
  { value: 'completed', label: 'Completed', color: 'text-emerald-600 bg-emerald-50 border-emerald-200', icon: '✅' },
  { value: 'cancelled', label: 'Cancelled', color: 'text-gray-600 bg-gray-50 border-gray-200', icon: '❌' },
] as const;

// Urgency options with colors
const urgencyOptions = [
  { value: 'emergency', label: 'Emergency', color: 'text-red-600 bg-red-50 border-red-200', icon: '🚨' },
  { value: 'high', label: 'High', color: 'text-orange-600 bg-orange-50 border-orange-200', icon: '🔥' },
  { value: 'medium', label: 'Medium', color: 'text-yellow-600 bg-yellow-50 border-yellow-200', icon: '⚠️' },
...
export default function EventEditForm({ event, onSave, onCancel, loading = false }: EventEditFormProps) {
          ...
          >
            <div className="flex items-center justify-between">
              ...
              >
                ...
                <p className="text-muted-foreground mt-2 text-base font-medium">Update event details and information</p>
              </motion.div>
              <motion.button
                onClick={onCancel}
                ...
                whileTap={{ scale: 0.95 }}
              >
                <svg className="w-6 h-6 text-muted-foreground group-hover:text-destructive transition-colors" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <span>Add details, special instructions, or any relevant information</span>
                </motion.p>
              </motion.div>
            </motion.form>
          </div>
