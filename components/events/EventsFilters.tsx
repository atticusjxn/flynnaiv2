            ...
            <div className="flex items-center space-x-2">
              ...
              <div className="flex flex-wrap gap-1">
                ...
                {filters.urgency.map((urgency) => (
                  <span
                    key={urgency}
                    className="inline-flex items-center bg-orange-600 text-white text-xs px-2 py-1 rounded-full"
                  >
                    {urgency}
                    <button
                      onClick={() => toggleUrgencyFilter(urgency)}
                ...
                {filters.industry.map((industry) => (
                  <span
                    key={industry}
                    className="inline-flex items-center bg-green-600 text-white text-xs px-2 py-1 rounded-full"
                  >
                    {industry}
                    <button
                      onClick={() => toggleIndustryFilter(industry)}
