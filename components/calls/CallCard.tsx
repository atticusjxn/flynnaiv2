...
const CallCard = memo(function CallCard({
  ...
  return (
    <Card className="group hover:shadow-lg transition-all duration-300 ease-out hover:scale-[1.01] hover:border-primary/20 bg-card border border-border shadow-sm">
