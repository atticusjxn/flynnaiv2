...
import { Input, Select, SelectItem, Button, Chip, DateRangePicker } from '@nextui-org/react';
...
type AIProcessingStatus = Database['public']['Tables']['calls']['Row']['ai_processing_status'];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-4">
          ...
          <div className="lg:col-span-2">
            <Input
              ...
              classNames={{
                input: "text-sm",
                inputWrapper: "hover:border-primary/30 focus-within:border-primary/50 transition-colors duration-200",
              }}
            />
          </div>
      ...
      {hasActiveFilters && (
        <div className="flex flex-wrap items-center gap-2">
          ...
          {filters.urgency.map((urgency) => (
            ...
            >
              Urgency: {urgencyOptions.find(opt => opt.key === urgency)?.label}
            </Chip>
          ))}
