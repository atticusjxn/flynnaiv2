...
const processingModes = [
  {
    ...
    description:
      'Fastest processing with good accuracy. Best for high-volume operations.',
    features: [
      '< 1 minute processing',
      'Good accuracy (~85%)',
      'Lower cost per call',
  ...
  },
  {
    ...
    description:
      'Optimal balance of speed and accuracy for most business needs.',
    features: [
      '< 2 minute processing',
      'High accuracy (~90%)',
      'Standard cost per call',
    ],
  },
  {
    value: 'accuracy',
    ...
    description:
      'Maximum accuracy with detailed analysis. Best for critical appointments.',
    features: [
      '2-5 minute processing',
      'Highest accuracy (~95%)',
      'Premium cost per call',
    ],
  },
];
...
const transcriptionQualities = [
  {
    ...
    description:
      'Good quality for clear phone calls with minimal background noise',
  },
  {
    value: 'enhanced',
    label: 'Enhanced Quality',
    description:
      'Better handling of accents, background noise, and poor call quality',
  },
];
...
export default function AISettings({
  ...
  const removeCustomKeyword = (index: number) => {
    const keywords =
      localSettings.customKeywords?.filter((_, i) => i !== index) || [];
    handleChange('customKeywords', keywords);
  };
    ...
    >
      ...
      <div className="space-y-6">
        <div>
          ...
          <p className="text-muted-foreground text-sm">
            Choose how Flynn.ai processes your calls based on your speed and
            accuracy needs
          </p>
        </div>
      ...
      <div className="space-y-6">
        <div>
          ...
          <p className="text-muted-foreground text-sm">
            Set AI confidence levels for automatic actions and human review
            requirements
          </p>
        </div>
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Automatically confirm events when AI confidence is above this
                level
              </p>
            </div>
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                ...
                <span className="font-medium text-foreground">
                  {formatThreshold(localSettings.autoConfirmThreshold)}%
                  Confidence
                </span>
                <span className="text-sm text-muted-foreground">
                  Aggressive
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Flag events for manual review when AI confidence is below this
                level
              </p>
            </div>
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                ...
                <span className="font-medium text-foreground">
                  {formatThreshold(localSettings.humanReviewThreshold)}%
                  Confidence
                </span>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div className="text-sm">
                ...
                <div className="text-blue-700">
                  <p className="mb-2">
                    <strong>Above Auto-confirm:</strong> Events are
                    automatically confirmed and added to your calendar
                  </p>
                  <p className="mb-2">
                    <strong>Between thresholds:</strong> Events are extracted
                    but require your manual review
                  </p>
                  <p>
                    <strong>Below Review threshold:</strong> Events are flagged
                    for attention and may need significant editing
                  </p>
                </div>
              </div>
            </div>
      ...
      <div className="space-y-6">
        <div>
          ...
          <p className="text-muted-foreground text-sm">
            Configure how AI extracts appointments and events from call
            conversations
          </p>
        </div>
          ...
          {[
            {
              ...
              description:
                'Allow AI to find multiple appointments in a single call',
            },
            {
              key: 'requireExplicitTime',
              label: 'Require Explicit Time',
              description:
                'Only extract events when specific times are mentioned (e.g., "2 PM tomorrow")',
            },
            {
              key: 'requireLocation',
              label: 'Require Location Details',
              description:
                'Only extract events when location or address information is provided',
            },
            {
              key: 'industryOptimizations',
              label: 'Industry Optimizations',
              description:
                'Use industry-specific processing rules for better accuracy',
            },
          ].map((setting) => (
            <label
              key={setting.key}
            ...
            >
              <input
                ...
                onChange={(e) =>
                  handleChange(
                    setting.key as keyof UserSettings['ai'],
                    e.target.checked
                  )
                }
      ...
      <div className="space-y-6">
        <div>
          ...
          <p className="text-muted-foreground text-sm">
            Add industry-specific or business-specific keywords to improve AI
            recognition
          </p>
        </div>
        ...
        <div className="space-y-4">
          ...
          {/* Current Keywords */}
          {localSettings.customKeywords &&
            localSettings.customKeywords.length > 0 && (
          ...
          <div className="text-xs text-muted-foreground bg-muted/20 rounded-lg p-3">
            <strong>Examples:</strong> "site visit", "property inspection",
            "emergency repair", "follow-up appointment"
          </div>
        </div>
      </div>
      ...
      <div className="space-y-6">
        <div>
          ...
          <p className="text-muted-foreground text-sm">
            Configure what actions Flynn.ai can take automatically based on
            extracted events
          </p>
        </div>
          ...
          {[
            {
              ...
              description:
                'Automatically confirm events that exceed the confidence threshold',
              warning: true,
            },
            {
              ...
              description:
                'Automatically add confirmed events to your connected calendars',
            },
            {
              key: 'autoSendCustomerEmails',
              label: 'Auto-send Customer Emails',
              description:
                'Automatically send confirmation emails to customers (when email available)',
              warning: true,
            },
          ].map((setting) => (
            <label
            ...
            <div className="flex items-start space-x-3">
              ...
              <div className="text-sm">
                <div className="font-medium text-amber-800 mb-1">
                  Automatic Actions Warning
                </div>
                <div className="text-amber-700">
                  Automatic actions can save time but may occasionally act on
                  incorrectly interpreted information. Start with conservative
                  settings and monitor results before enabling aggressive
                  automation.
                </div>
              </div>
            </div>
                ...
                >
                  <div className="flex items-start space-x-3">
                    <input
                      ...
                      onChange={(e) =>
                        handleChange('transcriptionQuality', e.target.value)
                      }
                      className="w-4 h-4 text-primary border-border focus:ring-primary focus:ring-2 mt-1"
                    />
                    <div>
      ...
      <div className="space-y-6">
        <div>
          ...
          <p className="text-muted-foreground text-sm">
            Configure how long Flynn.ai keeps your call recordings and
            transcriptions
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="space-y-4">
            <label className="flex items-center justify-between">
              <div>
                ...
                <div className="text-sm text-muted-foreground">
                  Store audio recordings for playback and analysis
                </div>
              </div>
              <input
                type="checkbox"
                ...
                onChange={(e) =>
                  handleChange('keepRecordings', e.target.checked)
                }
            ...
            {localSettings.keepRecordings && (
              <div className="space-y-2">
                <Label htmlFor="recordingRetention">
          ...
          <div className="space-y-4">
            <label className="flex items-center justify-between">
              <div>
                <div className="font-medium text-foreground">
                  Keep Call Transcripts
                </div>
                <div className="text-sm text-muted-foreground">
                  Store text transcriptions for searching and analysis
                </div>
              </div>
              <input
                type="checkbox"
                ...
                onChange={(e) =>
                  handleChange('keepTranscripts', e.target.checked)
                }
                className="w-4 h-4 text-primary border-border rounded focus:ring-primary focus:ring-2"
              />
            </label>
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
          <div className="flex items-start space-x-3">
            ...
            <div className="text-sm">
              ...
              <div className="text-blue-700">
                Shorter retention periods save storage costs but limit your
                ability to review historical calls. Consider your business
                needs, compliance requirements, and storage budget when setting
                retention periods.
              </div>
            </div>
          </div>
