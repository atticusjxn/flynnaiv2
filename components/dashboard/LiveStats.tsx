  ...
  const statCards: StatCard[] = [
    {
      ...
      trend: {
        direction:
          stats.totalCalls > previousStats.totalCalls ? 'up' : 'neutral',
        value: '+23%',
        label: 'vs last month',
      },
    ...
    },
    {
      ...
      trend: {
        direction:
          stats.eventsExtracted > previousStats.eventsExtracted
            ? 'up'
            : 'neutral',
        value: '+5.2%',
    ...
    },
    {
      ...
      trend: {
        direction:
          stats.avgResponseTime < previousStats.avgResponseTime
            ? 'up'
            : 'neutral',
        value: '-15s',
    ...
    },
    {
      ...
      trend: {
        direction:
          stats.calendarSyncRate > previousStats.calendarSyncRate
            ? 'up'
            : 'neutral',
        value: '+2.1%',
        label: 'vs last week',
