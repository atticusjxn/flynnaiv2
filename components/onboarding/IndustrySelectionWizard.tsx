...
const INDUSTRIES: Industry[] = [
  {
    ...
    label: 'Plumbing & HVAC',
    description:
      'Service calls, emergency repairs, and maintenance appointments',
    icon: '🔧',
    keyFeatures: [
      'Emergency detection',
      'Service addresses',
    ...
    primaryColor: '#1e40af',
    examples: [
      'Emergency leak repair at 123 Main St tomorrow at 2 PM',
      'Schedule routine maintenance next week',
    ],
  },
  {
    ...
    primaryColor: '#059669',
    examples: [
      'Show the downtown condo to the Johnsons Friday at 3 PM',
  ...
  },
  {
    ...
    primaryColor: '#7c3aed',
    examples: [
      'Initial consultation for divorce case Monday morning',
  ...
  },
  {
    ...
    primaryColor: '#dc2626',
    examples: [
      'Schedule annual checkup next month',
      'Urgent appointment needed this week',
    ],
  },
  {
    ...
    primaryColor: '#ea580c',
    examples: [
      'Product demo for enterprise client Thursday',
      'Follow-up call with qualified lead',
    ],
  },
  {
    ...
    primaryColor: '#0891b2',
    examples: [
      'Strategic planning workshop next Tuesday',
      'One-on-one consultation scheduled',
    ],
  },
  {
    ...
    primaryColor: '#6366f1',
    examples: [
      'Business meeting scheduled for next week',
      ...
      {showHeader && (
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-slate-600 max-w-3xl mx-auto leading-relaxed">
            Flynn.ai adapts its AI processing to understand your industry's
            terminology and extract the right types of appointments from your
            calls. Choose the option that best describes your business.
          </p>
        </div>
      )}
            ...
            >
                ...
                <div className="flex items-start justify-between w-full">
                  <div className="flex items-start gap-4">
                    ...
                    <div className="relative">
                      ...
                      >
                        ...
                        {selectedIndustry === industry.id && (
                          <div
                            ...
                            style={{
                              borderColor: `${industry.primaryColor}60`,
                            }}
                          />
                        )}
                      </div>
                      ...
                      {['plumbing', 'real_estate', 'sales'].includes(
                        industry.id
                      ) && (
              ...
              <CardBody className="pt-0 space-y-4">
                ...
                <div>
                  ...
                  <div
                    className={`text-xs italic p-3 rounded-lg transition-all duration-300 ${
                      selectedIndustry === industry.id
          ...
          <div className="relative bg-white/80 backdrop-blur-sm border border-green-200/50 rounded-2xl p-8 shadow-xl shadow-green-500/10">
            <div className="flex items-start gap-6">
              ...
              <div className="relative flex-shrink-0">
                ...
                <div
                  className="absolute inset-0 border border-green-300/40 rounded-2xl animate-ping"
              ...
              <div className="flex-1">
                ...
                <p className="text-slate-600 leading-relaxed mb-4">
                  Flynn.ai is now specifically optimized for{' '}
                  <strong className="text-slate-800">
                    {INDUSTRIES.find((i) => i.id === selectedIndustry)?.label}
                  </strong>{' '}
                  businesses. Our AI will understand your industry terminology
                  and extract the most relevant appointment types.
                </p>
                ...
                <div className="mt-6 pt-4 border-t border-green-200/50">
                  <p className="text-xs text-slate-500">
                    Need to change this later? No problem - you can update your
                    industry selection anytime in your account settings.
                  </p>
                </div>
              </div>
            </div>
