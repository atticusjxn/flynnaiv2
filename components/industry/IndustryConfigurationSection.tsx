...
export default function IndustryConfigurationSection() {
  ...
  const [currentIndustry, setCurrentIndustry] =
    useState<IndustryConfiguration | null>(null);
    ...
    <div className="space-y-8">
      ...
      <div>
        ...
        <p className="text-muted-foreground">
          Customize Flynn.ai to match your business needs and industry
          requirements
        </p>
      </div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
            <div className="space-y-2">
              ...
              <p className="text-muted-foreground">
                {currentIndustry.defaultDuration} minutes
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-muted-foreground">
                {currentIndustry.urgencyLevels.length} configured
              </p>
            </div>
          </div>
        </motion.div>
