...
const CDN_CONFIG = {
  ...
  securityHeaders: {
    'Content-Security-Policy': {
      'default-src': "'self'",
      'script-src':
        "'self' 'unsafe-inline' 'unsafe-eval' https://js.stripe.com https://maps.googleapis.com",
      'style-src': "'self' 'unsafe-inline' https://fonts.googleapis.com",
      'font-src': "'self' https://fonts.gstatic.com",
      'img-src': "'self' data: https: blob:",
      'connect-src':
        "'self' https://*.supabase.co https://api.openai.com https://api.twilio.com https://api.resend.com https://api.stripe.com",
