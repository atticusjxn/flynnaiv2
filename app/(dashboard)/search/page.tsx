...
const mockSearchData = [
  {
    ...
    description:
      'Customer reported a major leak under kitchen sink. Water is flooding the floor and needs immediate attention.',
    metadata: {
    ...
    highlights: [
      {
        field: 'description',
        snippet: 'Customer reported a major leak under kitchen sink...',
      },
    ],
    relevanceScore: 0.95,
  },
  {
    ...
    description:
      'Initial consultation for full bathroom renovation project including tile work, plumbing updates, and fixture installation.',
    metadata: {
  ...
  },
  {
    ...
    description:
      'Client interested in viewing the 2-bedroom luxury condo downtown. Pre-approved for up to $850K.',
    metadata: {
...
export default function SearchPage() {
  ...
  const [localSavedSearches, setLocalSavedSearches] =
    useState(mockSavedSearches);
        ...
        <div className="flex items-center gap-4 mb-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground text-lg">
              Search across calls, events, and communications with powerful
              filters
            </p>
          </div>
        </div>
          ...
          <CardBody className="text-center py-12">
            <div className="max-w-md mx-auto">
              ...
              <p className="text-muted-foreground mb-6">
                Use the search bar above to find calls, events, customers, and
                more. Try searching for "emergency", "plumbing", or customer
                names.
              </p>
