...
const settingsTabs: SettingsTab[] = [
  ...
  },
  {
    ...
    description: 'Email notifications, content preferences, and delivery settings',
  ...
  },
  {
    ...
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 17h5l-5 5v-5zM8.828 8.828L3 15l1.414 1.414 5.657-5.657-1.243-1.243z" />
      </svg>
    ),
  ...
  },
  {
    ...
    description: 'AI processing modes, confidence settings, and automation preferences',
          ...
          <div className="lg:w-80 flex-shrink-0">
            <div className="bg-card border border-border rounded-xl shadow-sm overflow-hidden sticky top-8">
              <div className="p-6 border-b border-border">
                <h2 className="font-semibold text-foreground">Settings Categories</h2>
              ...
              <div className="p-4 border-t border-border">
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                  <div className="flex items-center space-x-2 mb-2">
                    ...
                    <span className="font-medium text-blue-800 text-sm">Industry Settings</span>
                  </div>
                ...
                {error && (
                  ...
                  >
                    <div className="flex items-start space-x-3">
                      ...
                      <div className="flex-1">
                        <div className="font-medium text-red-800">Settings Error</div>
