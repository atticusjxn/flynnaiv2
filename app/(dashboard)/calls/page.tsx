...
const mockCalls: CallRecord[] = [
  {
    ...
    transcription_text:
      "Hi, I need to schedule a plumbing service for tomorrow morning. I have a leak in my kitchen sink that's getting worse. Can we set up an appointment around 10 AM?",
    transcription_confidence: 0.92,
    ai_processing_status: 'completed',
    main_topic: 'Emergency Plumbing Service Request',
    call_summary:
      'Customer John Smith needs urgent plumbing service for kitchen sink leak. Prefers morning appointment around 10 AM tomorrow.',
  ...
  },
  {
    ...
    transcription_text:
      "I'd like to get a quote for installing new fixtures in my bathroom. When would be a good time to have someone come take a look?",
    transcription_confidence: 0.88,
    ai_processing_status: 'completed',
    main_topic: 'Bathroom Fixture Installation Quote',
    call_summary:
      'Customer Sarah Johnson requesting quote for bathroom fixture installation. Needs scheduling for assessment visit.',
  ...
  },
  {
    ...
    recording_sid: null,
    transcription_text:
      'Hello, is this ABC Plumbing? I was calling to follow up on my service request from last week.',
    transcription_confidence: 0.85,
    ai_processing_status: 'completed',
    main_topic: 'Follow-up on Previous Service',
    call_summary:
      'Customer following up on previous service request. Short call requesting status update.',
  ...
  },
  {
    ...
    transcription_text:
      "This is an emergency! My basement is flooding and I think it's coming from the main water line. I need someone here immediately!",
    transcription_confidence: 0.95,
    ai_processing_status: 'completed',
    main_topic: 'Emergency Water Line Break',
    call_summary:
      'EMERGENCY: Customer Mike Rodriguez has flooding in basement from main water line. Requires immediate response.',
      ...
      try {
        ...
        await new Promise((resolve, reject) => {
          setTimeout(
            ...
            1000 + attempt * 500
          ); // Progressively longer delays for retries
        });
        ...
        if (attempt < maxRetries) {
          ...
          setError(
            `Failed to load calls after ${maxRetries + 1} attempts: ${errorMessage}`
          );
        }
      } finally {
        setIsLoading(false);
          ...
          <div className="bg-card/50 backdrop-blur-sm border border-border/50 rounded-xl p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-foreground">
                  {
                    calls.filter((call) => call.urgency_level === 'emergency')
                      .length
                  }
                </p>
              </div>
