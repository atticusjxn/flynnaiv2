...
export default function HomePage() {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100">
        <div className="flex items-center space-x-4">
          ...
          <span className="text-lg font-medium text-gray-700">Loading Flynn.ai...</span>
        </div>
      </div>
    );
  }
  ...
  const australianIndustries = [
    { name: 'Plumbing & HVAC', icon: WrenchScrewdriverIcon, users: '12,000+', color: 'from-blue-500 to-blue-600' },
    { name: 'Real Estate', icon: BuildingOfficeIcon, users: '8,500+', color: 'from-emerald-500 to-emerald-600' },
    { name: 'Legal Services', icon: ScaleIcon, users: '3,200+', color: 'from-purple-500 to-purple-600' },
    { name: 'Healthcare', icon: HeartIcon, users: '5,800+', color: 'from-pink-500 to-pink-600' }
  ];
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="inline-flex items-center px-4 py-2 bg-gradient-to-r from-blue-100 to-indigo-100 border border-blue-200 rounded-full mb-8 shadow-sm">
              ...
              <span className="text-sm font-semibold text-blue-800">Trusted by 25,000+ Australian Professionals</span>
            </div>
            ...
            <p className="text-xl md:text-2xl text-gray-600 mb-12 leading-relaxed max-w-3xl mx-auto">
              Australia's #1 AI-powered call intelligence platform. Transform every business phone call into organized calendar events 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Industry-specific AI that understands Australian business terminology, time zones, and professional requirements
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
            {australianIndustries.map((industry, index) => (
              ...
              >
                <div className={`w-16 h-16 bg-gradient-to-br ${industry.color} rounded-2xl flex items-center justify-center mb-6 shadow-lg group-hover:shadow-xl transition-shadow duration-300`}>
                  <industry.icon className="w-8 h-8 text-white" />
                </div>
                <h3 className="text-lg font-bold text-gray-900 mb-2">{industry.name}</h3>
                <p className="text-sm text-gray-600 mb-3">{industry.users} active users</p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="text-center">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Setup Call Forwarding</h3>
              <p className="text-gray-600 leading-relaxed">
                Get your Flynn.ai number and set up call forwarding in under 2 minutes. 
                Works with Telstra, Optus, Vodafone, and all Australian carriers.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4">AI Processes Calls</h3>
              <p className="text-gray-600 leading-relaxed">
                Our AI automatically detects business calls, extracts appointment details, 
                and identifies urgency levels using Australian business context.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Get Organized Events</h3>
              <p className="text-gray-600 leading-relaxed">
                Receive SMS summaries, professional emails, and calendar events within 2 minutes. 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-gray-400 mb-8 max-w-2xl mx-auto">
              Australia's premier AI-powered call intelligence platform. 
              Trusted by professionals across all industries to never miss another business opportunity.
            </p>
