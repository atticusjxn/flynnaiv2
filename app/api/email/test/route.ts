      ...
      extractedEvents: [
        {
          ...
          description: 'Customer reports burst pipe under kitchen sink causing flooding. Needs immediate attention to prevent water damage.',
          type: 'emergency',
          proposed_datetime: new Date(Date.now() + 2 * 60 * 60 * 1000).toISOString(), // 2 hours from now
        ...
        },
        {
          ...
          description: 'Schedule follow-up inspection to check repair quality and identify any other potential issues.',
          type: 'service_call',
