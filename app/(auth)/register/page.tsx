...
export default function RegisterPage() {
  ...
  const validateForm = () => {
    if (!formData.email || !formData.password || !formData.fullName || !formData.companyName || !formData.industryType) {
      ...
      <div className="max-w-md w-full space-y-8">
        <div>
          <div className="mx-auto h-12 w-12 flex items-center justify-center rounded-full bg-accent">
            <div className={`w-6 h-6 rounded-full ${emailSent ? 'bg-primary' : 'bg-primary'}`}></div>
          </div>
        ...
        {!emailSent && (
          ...
          <div className="space-y-4">
            ...
            {/* Industry Selection */}
            <div>
              <label htmlFor="industryType" className="block text-sm font-medium text-foreground">
                Industry *
              </label>
